...
OpenGL::VKNodes::BufferSubData::BufferSubData(const IContextObjectManagers*      in_frontend_ptr,
     ...
     m_sub_size						(in_sub_size)
{
	...
	m_sub_size = (m_start_offset + m_sub_size) > size ? size - m_start_offset
															: m_sub_size;
	vkgl_assert(m_sub_size >= 0);
...
OpenGL::VKNodes::BufferSubData::~BufferSubData()
{
    FUN_ENTRY(DEBUG_DEPTH);
...
bool OpenGL::VKNodes::BufferSubData::can_memory_block_handle_frontend_reqs(const Anvil::MemoryBlock*   in_mem_block_ptr,
...
OpenGL::VKFrameGraphNodeUniquePtr OpenGL::VKNodes::BufferSubData::create(const IContextObjectManagers*      in_frontend_ptr,
                                                                      ...
                                                                      uint64_t							in_sub_size)
{
    ...
    result_ptr.reset(
        new OpenGL::VKNodes::BufferSubData(in_frontend_ptr,
                                        in_backend_ptr,
...
void OpenGL::VKNodes::BufferSubData::do_cpu_prepass(IVKFrameGraphNodeCallback*)
{
    FUN_ENTRY(DEBUG_DEPTH);
    ...
    /* 2. Do we need a new VK mem block instance? */
    {
        ...
        vkgl_assert(backend_mem_block_ptr != nullptr);
    }
...
void OpenGL::VKNodes::BufferSubData::get_supported_queue_families(uint32_t*                          out_n_queue_fams_ptr,
...
void OpenGL::VKNodes::BufferSubData::record_commands(Anvil::CommandBufferBase*  in_cmd_buffer_ptr,
                                                  ...
                                                  IVKFrameGraphNodeCallback* in_graph_callback_ptr) const
{
    ...
    if (m_staging_buffer_ptr != nullptr)
    {
        ...
        copy_region.dst_offset = m_start_offset;
...
bool OpenGL::VKNodes::BufferSubData::requires_gpu_side_execution() const
{
    FUN_ENTRY(DEBUG_DEPTH);
...
OpenGL::RenderpassSupportScope OpenGL::VKNodes::BufferSubData::get_renderpass_support_scope() const
{
    FUN_ENTRY(DEBUG_DEPTH);
